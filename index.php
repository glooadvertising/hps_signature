            ...
            <table style="color: inherit; padding-bottom: 20px;">
                    <tr style="display: flex;">
                        ...
                        <td style="padding-left: 30px; display: flex; flex-direction: column;">
                            ...
                            <span style="color: inherit; font-size: 8pt; padding-bottom: 3px;">P <a id="phone" href="tel:<?php echo trim($individual[0][1]['phone']); ?>" style="color: inherit; text-decoration: none; text-decoration: none;"><?php echo $individual[0][1]['phone']; ?></a>  F <a href="tel:<?php echo trim($individual[0][1]['fax']); ?>" id="fax" style="color: inherit; text-decoration: none;"><?php echo $individual[0][1]['fax']; ?></a></span>
